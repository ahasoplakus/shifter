...
The workflow below shows a step-by-step programming approach to create Laboratory Shift Tables using the `{tidyverse}` suite for data processing, and `{gt}` to create the desired Shift Table layout.
