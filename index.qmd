...
There are several summary tables commonly used to present laboratory results viz descriptive statistics, CTCAE summaries 
and shift tables are some of the most widely used ones. The shift table is one of the most frequently requested outputs in a clinical trial by statisticians or clinicians.
