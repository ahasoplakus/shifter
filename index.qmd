---
title: "Tidy Shift Tables for Clinical Trials"
author: Sukalpo Saha
date: 2024-04-24
abstract-title: " What is a Shift Table?"
abstract: "A shift table is a table that displays the number of subjects who are low, normal or high at baseline and the shift at post-dose. It represents cross frequencies of baseline values with post-dose values."
---

<b>Shift Tables in Clinical Trials</b>
...
The main purpose of shift tables in any clinical trial is to determine how the categorical result varies from baseline to post-dose. <b>Table 1</b> below represents a Shift Table for Hemoglobin Records depicting the number of subjects who are low, normal, or high at baseline and post-dose together.

![Table 1](img/shift.png)
