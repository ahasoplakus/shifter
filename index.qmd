...
There are several summary tables commonly used to present laboratory results. Descriptive statistics, shift tables 
and CTCAE summaries are some of most widely used ones. The shift table is one of the most frequently requested output in a clinical study by statisticians or clinicians.

<b>Figure 1</b> represents a Shift Table showing the number of subjects with low, normal, or high <b>Hemoglobin</b> records at baseline and post-dose together.
